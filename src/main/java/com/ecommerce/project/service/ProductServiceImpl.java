...
public class ProductServiceImpl implements ProductService{
    ...
    public ProductResponse searchByCategory(Long categoryId, Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        if(products.size()==0){
            throw new ApiException("Product Not Exists with Category id "+categoryId);
        }
    ...
    public ProductResponse searchProductByKeyword(String keyword, Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        Sort sortByAndOrder = sortOrder.equalsIgnoreCase("asc") ? Sort.by(sortBy).ascending() : Sort.by(sortBy).descending();
        Pageable pageable = PageRequest.of(pageNumber,pageSize,sortByAndOrder);
        Page<Product> productPage = productRepository.findProductByProductNameLikeIgnoreCase("%"+keyword+"%",pageable);
        List<Product> products = productPage.getContent();

        if(products.size()==0){
            throw new ApiException("Product Not Exists with this keyword "+keyword);
        }
